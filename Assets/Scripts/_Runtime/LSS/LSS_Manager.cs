...
namespace Michsky.LSS
{
	...
	public class LSS_Manager : MonoBehaviourSingleton<LSS_Manager>
	{
		// Settings
		...
		public void LoadScene(string sceneName)
		{
			...
			HandleAudioAndLoadEvent();
		}

		public void LoadScene(int sceneIndex)
		{
			LSS_LoadingScreen.presetName = presetName;
			LSS_LoadingScreen.LoadScene(sceneIndex);
		...
		{
			LSS_LoadingScreen.LoadSceneAdditive(sceneIndex, presetName);
			loadedScenes.Add(SceneManager.GetSceneAt(sceneIndex).name);
